...
ids = ["ae", "a", "e"]
data = ["gcn4_0.3_sim_ancestors_0.3_sim_extants_no_dupes.aln", 
        "gcn4_0.3_sim_ancestors_no_dupes.aln",
        "gcn4_0.3_sim_extants_no_dupes.aln"]


for g, id, d, in zip(groups, ids, data):

    data = {
        "alignment": f"/scratch/user/s4646506/gcn4/curated/alns/{d}",
