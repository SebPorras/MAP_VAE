...
wandb.init(
    ...
    # hyperparameters
    config={"AA_count": 21,
            "alignment": f"/scratch/user/s4646506/gb1/random_sampling/data/gb1_ancestors_no_dupes_encoded_weighted_0.4_sample_r{rep}.pkl",
            ...
            "info": f"gb1_ancestors_no_dupes_r{rep}_sample_0.4",
            "latent_dims": 3,
            "learning_rate": 0.001,
            "max_mutation": 4,
            "max_norm": 5,
