...
gfp_ae_latent, gfp_a_latent, gfp_e_latent = vs.get_model_embeddings(
    path,
...
gb1_ae_latent, gb1_a_latent, gb1_e_latent = vs.get_model_embeddings(
    path,
...
a4_ae_latent, a4_a_latent, a4_e_latent = vs.get_model_embeddings(
    path,
...
gcn4_ae_latent, gcn4_a_latent, gcn4_e_latent = vs.get_model_embeddings(
    path,
...
a_state_dict = (
    "/Users/sebs_mac/uni_OneDrive/honours/data/vis_models/gcn4_a_r1_model_state.pt"
)
e_state_dict = (
    "/Users/sebs_mac/uni_OneDrive/honours/data/vis_models/gcn4_e_r1_model_state.pt"
)
...
mafg_ae_latent, mafg_a_latent, mafg_e_latent = vs.get_model_embeddings(
    path,
...
vs.vis_tree(
    "SPG1_STRSG/1-448", gb1_tree, e_state_dict, settings, "GB1 - Extant model", rgb=True
)
# -
...
vs.vis_tree(
    "A4_HUMAN/1-770", a4_tree, a_state_dict, settings, "A4 - Ancestor model", rgb=True
)
vs.vis_tree(
    "A4_HUMAN/1-770", a4_tree, e_state_dict, settings, "A4 - Extant model", rgb=True
)
...
path = (
    "/Users/sebs_mac/uni_OneDrive/honours/data/gfp/independent_runs/no_synthetic/vis/"
)
...
vs.vis_tree(
    "GFP_AEQVI/1-238", gfp_tree, e_state_dict, settings, "GFP - Extant model", rgb=True
)
...
vis_variants_3d(
    ...
    device=device,
    title="GB1: Ancestor model - Variants",
    variant_data=variants,
    variant_loader=loader,
)


vis_variants_3d(
    model,
    state_dict=e_state_dict,
    device=device,
    title="GB1: Extant model - Variants",
    variant_data=variants,
    variant_loader=loader,
)
...
vis_variants_3d(
    ...
    state_dict=a_state_dict,
    device=device,
    title="A4: Ancestor model - Variants",
    variant_data=variants,
    variant_loader=loader,
)
...
vis_variants_3d(
    ...
    state_dict=e_state_dict,
    device=device,
    title="A4: Extant model - Variants",
    variant_data=variants,
    variant_loader=loader,
)
...
vis_variants_3d(
    ...
    state_dict=a_state_dict,
    device=device,
    title="MAFG: Ancestor model - Variants",
    variant_data=variants,
    variant_loader=loader,
)
...
vis_variants_3d(
    ...
    state_dict=e_state_dict,
    device=device,
    title="MAFG: Extant model - Variants",
    variant_data=variants,
    variant_loader=loader,
)
...
vis_variants_3d(
    ...
    state_dict=a_state_dict,
    device=device,
    title="GFP: Ancestor model - Variants",
    variant_data=variants,
    variant_loader=loader,
)
...
vis_variants_3d(
    ...
    state_dict=e_state_dict,
    device=device,
    title="GFP: Extant model - Variants",
    variant_data=variants,
    variant_loader=loader,
)
...
vis_variants_3d(
    ...
    state_dict=a_state_dict,
    device=device,
    title="GCN4: Ancestor model - Variants",
    variant_data=variants,
    variant_loader=loader,
)
...
vis_variants_3d(
    ...
    state_dict=e_state_dict,
    device=device,
    title="GCN4: Extant model - Variants",
    variant_data=variants,
    variant_loader=loader,
)
...
id_to_color_hex = {
    id_: vs.rgb_to_hex_normalized(*color) for id_, color in id_to_color.items()
}
...
latent["COLOR"] = [
    id_to_color_hex[y] for y in latent["id"].apply(lambda x: x.split("_")[1])
]
